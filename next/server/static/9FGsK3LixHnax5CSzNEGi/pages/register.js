...
function Register({}) {
  ...
  const registerReducer = Object(react_redux__WEBPACK_IMPORTED_MODULE_9__["useSelector"])(state => state.registerReducer);
  ...
  }), __jsx(_material_ui_core_CardContent__WEBPACK_IMPORTED_MODULE_4___default.a, null, __jsx("form", {
    noValidate: true,
    onSubmit: () => {
      dispatch(_redux_actions__WEBPACK_IMPORTED_MODULE_10__[/* default */ "a"].register(account));
    },
  ...
  }, "Register"), __jsx(_material_ui_core_Button__WEBPACK_IMPORTED_MODULE_6___default.a, {
    fullWidth: true,
    size: "small",
    color: "primary",
    onClick: () => {
  ...
  }, "Cancel"), registerReducer.isFailed && __jsx(_material_ui_lab_Alert__WEBPACK_IMPORTED_MODULE_11___default.a, {
    severity: "error"
  }, "Register failed!")))), __jsx(styled_jsx_style__WEBPACK_IMPORTED_MODULE_0___default.a, {
    id: "830871713"
